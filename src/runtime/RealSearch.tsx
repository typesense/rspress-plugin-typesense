...
// @ts-expect-error virtual module generated by rspress
import typesenseConfig from 'virtual-typesense-config';
...
function Search({
  ...
  const resolvedCollectionName = `${typesenseConfig.collectionName}_${lang}`;
